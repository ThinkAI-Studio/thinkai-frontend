...
export function ArrowRoll({ className = "", size = "md" }: ArrowRollProps) {
  ...
  return (
    <span
      className={`relative overflow-hidden rounded-full bg-white/10 text-white group-hover:bg-white group-hover:text-black inline-flex items-center justify-center font-bold shrink-0 transition-colors duration-300 select-none leading-none ${sizeClasses} ${className}`}
    >
      {/* Primary Arrow */}
