...
export function TechLogo({ name, className = "w-6 h-6" }: { name: string; className?: string }) {
  switch (name) {
    case "Go":
      return (
        <span className={`font-black text-xl tracking-tighter ${className} flex items-center justify-center font-mono`}>
          GO
        </span>
      );
    case "Docker":
    ...
    case "Linux":
      return (
        <span className={`font-black text-sm tracking-wider ${className} flex items-center justify-center font-mono`}>
          LINUX
        </span>
      );
    case "PostgreSQL":
      return (
        <span className={`font-black text-xs tracking-tight ${className} flex items-center justify-center font-mono`}>
          POSTGRES
        </span>
      );
    case "Next.js":
